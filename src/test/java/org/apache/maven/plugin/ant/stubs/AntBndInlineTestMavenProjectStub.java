...
public class AntBndInlineTestMavenProjectStub extends AbstractAntTestMavenProjectStub {
    @Override
    public String getProjetPath() {
        return "ant-bnd-inline-test";
    }

    public AntBndInlineTestMavenProjectStub() {
        super();
